...
<html lang="en">
    ...
    <form action="buscar.php" method="GET">
        <input type="number" id="dato" name="dato" placeholder="Busque por No. Identificación" >
    </form>
    ...
    <table id="tabla">
        ...
        <tbody>
            <?php
            $listar = 'SELECT * FROM nomina WHERE identificacion LIKE "%' . $dato . '%" ORDER BY apellidos ASC;';
        ...
        <td>
        <center>
            <a href="eliminar.php?id=<?php echo $dato['id'] ?>"> <button class="eliminar" >Eliminar</button> </a>
        </center></td>
